  ...
  const handleCheckboxChange = (timeSlotId, courtId) => {
    ...
    if (isSelected) {
      ...
      const hasSameTimeSlotInOtherCourt = selectedTimeSlots.some((selected) => {
        return (
          normalizeTime(selected.startTime) === normalizedCurrentStartTime &&
          selected.courtId !== courtId
        );
      });
      ...
      // เพิ่มข้อมูล startTime/endTime เข้าไปด้วย
      const newSelectedTimeSlots = [
        ...selectedTimeSlots,
        {
          timeSlotId,
